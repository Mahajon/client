...
export default function LandingPage() {
  return (
    <main className="flex-1 ">
      ...
      <section className="lg:py-18 border-t bg-background py-12">
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[500px] text-gray-500 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Accelerate your team&apos;s productivity with the platform
                  built for the modern web. From the creators of Next.js, the
                  world&apos;s leading frontend framework.
                </p>
              </div>
            </div>
            <div className="grid gap-4 md:gap-8">
              <div className="flex flex-col gap-1.5">
                <CheckCircleIcon className="size-6 opacity-50" />
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  ...
                  Mahajon&apos;s efficient order management tools. Process
                  orders, manage returns, and keep your customers satisfied
      ...
      <section className=" w-full border-t py-12 md:py-24 lg:py-32 xl:py-40">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 xl:gap-12">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
            ...
            <div className="grid gap-4 md:gap-8">
              <div className="flex items-start gap-4">
                <div className="flex size-10 items-center justify-center rounded-full border border-gray-200 bg-white font-cal text-sm text-gray-900 shadow-sm dark:border-gray-950 dark:bg-gray-950 dark:text-gray-50">
                  1
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Use Mahajon&apos;s inventory and order management tools to
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 px-10 md:gap-16 lg:grid-cols-2">
            <div className="space-y-4">
              ...
              <Link
                className="focus-visible:ring-950 dark:focus-visible:ring-950 inline-flex h-9 items-center justify-center rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90"
                href="#"
              >
                Get Started
              </Link>
            ...
            <div className="flex flex-col items-start space-y-4">
              ...
              <Link
                className="focus-visible:ring-950 dark:focus-visible:ring-950 inline-flex h-9 items-center justify-center rounded-md border border-gray-200 bg-white px-4 py-2 text-sm font-medium shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 dark:border-gray-800 dark:bg-gray-950 dark:hover:bg-gray-800 dark:hover:text-gray-50"
                href="#"
              >
                Contact Sales
              </Link>
